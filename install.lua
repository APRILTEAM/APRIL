...
local RunBot = io.open("APRIL", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/APRIL
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr APRIL.lua
wget "https://raw.githubusercontent.com/APRILTEAM/APRIL/main/APRIL.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./APRIL.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S APRIL -X kill
screen -S APRIL ./APRIL
done
]])
RunTs:close()
end
