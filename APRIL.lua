...
if DevAPRILW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/CCGCC2/Files_APRIL/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/CCGCC2/Files_APRIL/main/File_Bot/"..file)
if res == 200 then
