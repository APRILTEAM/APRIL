...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/APRILTEAM/Files_APRIL/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevAPRILW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "CCVCC1")
...
local APRIL_Msg = ''  
if msgs < 100 then 
APRIL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
APRIL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
APRIL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
APRIL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
APRIL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
APRIL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
APRIL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
APRIL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
APRIL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
APRIL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
APRIL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
APRIL_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
APRIL_Msg = 'رب التفاعل'  
end 
return APRIL_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@CCXCC0")  
...
--------------------------------------------------------------------------------------------------------------
function SourceAPRIL(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'ابريل')
SourceAPRILr = '*⿻ ┆اهلا عزيزي*\n*⿻ ┆انا بوت اسمي '..Namot..'*\n*⿻ ┆اختصاصي حمايه الكروبات*\n*⿻ ┆من تكرار والسبام والتوجيه والخ…*\n*⿻ ┆لتفعيلي اتبع الاخطوات…↓*\n*⿻ ┆اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⿻ ┆[قناة سورس البوت](http://t.me/CCVCC1)'
end
send(msg.chat_id_, msg.id_, SourceAPRILr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevAPRILW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevAPRILW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,APRIL_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⿻' and DevAPRILW(msg) then  
...
if text == 'تعطيل التواصل ⿻' and DevAPRILW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⿻' and DevAPRILW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⿻' and DevAPRILW(msg) then  
...
if text == 'ضع كليشه ستارت ⿻' and DevAPRILW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⿻ ┆ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⿻' and DevAPRILW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⿻ ┆تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⿻' and DevAPRILW(msg) then 
...
if text == 'تحديث السورس ⿻' and DevAPRILW(msg) then 
os.execute('rm -rf APRIL.lua')
os.execute('wget https://raw.githubusercontent.com/APRILTEAM/APRIL/main/APRIL.lua')
send(msg.chat_id_, msg.id_,' *⿻ ┆تم تحديث السورس* \n*⿻ ┆لديك اخر اصدار لسورس ابريل*\n*⿻ ┆الاصدار » { 2.8v}*')
dofile('APRIL.lua')  
end
if text == 'الاصدار ⿻' and DevAPRILW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⿻ ┆اصدار سورس ابريل* \n*⿻ ┆الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⿻' and DevAPRILW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⿻ ┆[تحديثات البوت](t.me/CCGCC2) \n⿻ ┆[قناه السورس](t.me/CCVCC1)')
end
if text == "ضع اسم للبوت ⿻" and DevAPRILW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⿻' and DevAPRILW(msg) then 
...
if text == 'المشتركين ⿻' and DevAPRILW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⿻ ┆المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⿻' and DevAPRILW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⿻ ┆الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⿻") and DevAPRILW(msg) then
...
if text == ("قائمه العام ⿻") and DevAPRILW(msg) then
...
if text == ("قائمه الكتم العام ⿻") and DevAPRILW(msg) then
...
if text=="اذاعه خاص ⿻" and msg.reply_to_message_id_ == 0 and DevAPRILW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل الان اذاعتك؟* \n*⿻ ┆للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⿻" and msg.reply_to_message_id_ == 0 and DevAPRILW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل الان اذاعتك؟* \n*⿻ ┆للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⿻" and msg.reply_to_message_id_ == 0 and DevAPRILW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل الان اذاعتك؟* \n*⿻ ┆للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⿻" and msg.reply_to_message_id_ == 0  and DevAPRILW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⿻" and msg.reply_to_message_id_ == 0  and DevAPRILW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⿻ ┆ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⿻' and DevAPRILW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⿻" and DevAPRILW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⿻" and DevAPRILW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⿻ ┆عدد الكروبات الان » { '..#group..' }'..APRILk..''..APRIL..'*\n*⿻ ┆الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevAPRILW(msg) then
...
usertext = '*\n ⿻ ┆العضو »* ['..result.title_..'](t.me/'..(username or 'CCVCC1')..')'
status  = '\n *⿻ ┆تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevAPRILW(msg) then
...
usertext = '\n *⿻ ┆العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CCVCC1')..')'
status  = '\n*⿻ ┆تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevAPRILW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevAPRILW(msg) then
...
local APRIL1_Msg = database:get(bot_id.."APRIL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if APRIL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⿻ ┆العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CCVCC1')..') \n ⿻ ┆'..APRIL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if APRIL_Msg and not Special(msg) then  
local APRIL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if APRIL_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⿻ ┆العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⿻ ┆["..APRIL_Msg.."] \n")
else
send(msg.chat_id_,0," *⿻ ┆العضو :* {["..data.first_name_.."](T.ME/CCVCC1)}\n⿻ ┆["..APRIL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⿻ ┆عذرا »* {["..data.first_name_.."](T.ME/CCVCC1)}\n*⿻ ┆عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevAPRILW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevAPRILW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevAPRILW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⿻ ┆حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevAPRILW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⿻ ┆حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⿻" and DevAPRILW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⿻ ┆تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⿻$") and DevAPRILW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⿻ ┆حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⿻" and DevAPRILW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⿻" and DevAPRILW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⿻ ┆تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⿻" and DevAPRILW(msg) then  
...
database:sadd(bot_id.."APRIL:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."APRIL:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_APRIL = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_APRIL then 
names_APRIL = database:smembers(bot_id.."APRIL:blocname"..msg.chat_id_) or ""
if names_APRIL and names_APRIL[1] then 
for i=1,#names_APRIL do 
if name_APRIL:match("(.*)("..names_APRIL[i]..")(.*)") then 
...
database:set(bot_id.."APRIL:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."APRIL:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."APRIL:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."APRIL:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."APRIL:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_APRILa_new(APRIL1,APRIL2)
if APRIL2 and APRIL2.first_name_ then 
if APRIL2.first_name_:match("(.*)"..database:get(bot_id.."APRIL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."APRIL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local APRIL_nnn = database:get(bot_id.."APRIL:nump"..msg.chat_id_) or 5
local APRIL_nnn2 = database:get(bot_id.."APRIL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(APRIL_nnn2) == tonumber(APRIL_nnn) or tonumber(APRIL_nnn2) > tonumber(APRIL_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."APRIL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⿻ ┆عزيزي >>["..APRIL2.username_.."](https://t.me/"..(APRIL2.username_ or "CCVCC1")..")\n⿻ ┆عليك وضع التوحيد ⪼ {"..database:get(bot_id.."APRIL:teh"..msg.chat_id_).."} بجانب اسمك\n⿻ ┆عدد المحاولات المتبقيه {"..(tonumber(APRIL_nnn) - tonumber(APRIL_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_APRILa_new)
end
end
...
local APRILChengName = database:get(bot_id.."APRIL:Cheng:Name"..data.id_)
if not data.first_name_ then 
if APRILChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..APRILChengName..']')
database:del(bot_id.."APRIL:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if APRILChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."APRIL:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local APRILChengUserName = database:get(bot_id.."APRIL:Cheng:UserName"..data.id_)
if not data.username_ then 
if APRILChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..APRILChengUserName..']')
database:del(bot_id.."APRIL:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if APRILChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."APRIL:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local APRILChengPhoto = database:get(bot_id.."APRIL:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if APRILChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."APRIL:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if APRILChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."APRIL:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevAPRILW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⿻ ┆بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CCVCC1')..') \n*⿻ ┆تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⿻ ┆بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CCVCC1')..') \n*⿻ ┆تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevAPRILW(msg) then
dofile('APRIL.lua')  
send(msg.chat_id_, msg.id_, ' *⿻ ┆تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevAPRILW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevAPRILW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if APRILSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevAPRILW(msg) then
...
if APRILSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⿻ ┆لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevAPRILW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevAPRILW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevAPRILW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevAPRILW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevAPRILW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevAPRILW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevAPRILW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevAPRILW(msg) then
...
if text == 'الملفات' and DevAPRILW(msg) then
t = ' *⿻ ┆ملفات السورس ابريل ↓*\n*•━━━━━━ 𝗔𝗣 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevAPRILW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/APRILTEAM/Files_APRIL/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⿻ ┆اهلا بك في متجر ملفات ابريل*\n*⿻ ┆ملفات السورس ↓*\n*•━━━━━━ 𝗔𝗣 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝗔𝗣 ━━━━━━━•*\n *⿻ ┆علامة تعني { ✓ } ملف مفعل*\n *⿻ ┆علامة تعني { ✘ } ملف معطل*\n *⿻ ┆قناة سورس ابريل ↓*\n".." *⿻ ┆*[اضغط هنا لدخول](t.me/CCVCC1) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevAPRILW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/APRILTEAM/Files_APRIL/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('APRIL.lua')  
else
send(msg.chat_id_, msg.id_," *⿻ ┆عذرا الملف لايدعم سورس ابريل* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevAPRILW(msg) then
...
if text == "مسح الملفات" and DevAPRILW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⿻ ┆تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevAPRILW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevAPRILW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "CCVCC1")
...
function Function_APRIL(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_APRIL, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_APRIL, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⿻ ┆لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CCVCC1')..')'
status  = '\n*⿻ ┆تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⿻ ┆العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⿻ ┆العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CCVCC1')..')'
...
database:set(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."APRIL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."APRIL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⿻ ┆تم منع الكلمه مع التحذير*")  
database:del(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."APRIL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."APRIL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."APRIL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *⿻ ┆ارسل الكلمه الان*")  
database:set(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."APRIL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."APRIL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."APRIL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."APRIL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."APRIL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."APRIL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⿻ ┆قائمة المنع* \n*•━━━━━━ 𝗔𝗣 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local APRIL_Msg = database:get(bot_id.."APRIL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..APRIL_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevAPRILW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⿻ ┆تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevAPRILW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⿻ ┆العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'CCVCC1')..')'..'\n*⿻ ┆تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevAPRILW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevAPRILW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ابريل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ابريل')
local APRIL_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..APRIL_Msg[math.random(#APRIL_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevAPRILW(msg) then 
...
if APRILSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevAPRILW(msg) then 
...
if text == ("ردود المطور") and DevAPRILW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⿻ ┆قائمة ردود المطور \n*•━━━━━━ 𝗔𝗣 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevAPRILW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevAPRILW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ابريل').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevAPRILW(msg) then   
...
if text == 'تعطيل المغادره' and DevAPRILW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⿻ ┆العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APRIL')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CCVCC1')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
APRILdx(msg.chat_id_, msg.id_, ' *⿻ ┆ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⿻ ┆عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⿻ ┆عدد المحظورين » ( '..data.kicked_count_..' )*\n*⿻ ┆عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevAPRILW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ⿻∫ٴ*•━━━━━━ 𝗔𝗣 ━━━━━━━•*ٴ⿻∫○ٴ\n⿻ ┆[𝗔𝗣𝗥𝗜𝗟](t.me/CCVCC1) ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ابريل')
...
APRIL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(APRIL)
...
--------------------------------------------------------------------------------------------------------------
SourceAPRIL(data.message_,data)
...
------------------------------------------------------------------------
local APRILAbot = database:get(bot_id.."APRIL1:Add:Filter:Rp2"..text..result.chat_id_)   
if APRILAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⿻ ┆العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⿻ ┆["..APRILAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local APRIL1_Msg = database:get(bot_id.."APRIL1:Add:Filter:Rp2"..text..result.chat_id_)   
if APRIL1_Msg then
send(msg.chat_id_, msg.id_," ⿻ ┆"..APRIL1_Msg)
